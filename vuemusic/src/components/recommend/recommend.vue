<template>
     <div class="recommend" ref='recommend'>
           <scroll  ref='scroll' class="recommend-contant"  :data='discList'>
                <div>
                 <div v-if="recommends.length" class="slider-wrapper" >
                         <slider>
                                <div v-for="item in recommends" slot="first">
                                      <a :href="item.linkUrl" >
                                        <img @load="loadImage" :src="item.picUrl" class="needsclick">
                                      </a>
                                      <div  slot="second" class="ti">
                                                 <!-- biaodian -->
                                        </div>
                                </div>
                         </slider>
                 ...
                 <div class="recommend-list" >
                    ...
                    <ul>
                          <li v-for="item in discList" class="item">
                            <div class="icon">
                              <img v-lazy="item.cover_url_small" width="60" height="60" alt="" />
                            </div>
                            <div class="text">
